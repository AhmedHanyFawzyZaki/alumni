...
class UserType extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('user_type_name', 'required'),
            array('user_type_name', 'length', 'max' => 255),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('user_type_id, user_type_name', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function attributeLabels() {
        return array(
            ...
            'user_type_name' => Yii::t('t', 'User Type Name'),
        );
    }
    ...
    public function search() {
        ...
        $criteria->compare('Lower(user_type_name)', strtolower($this->user_type_name), true);
    ...
    public function getTypes() {
        return CHtml::listData(UserType::model()->findAll(array(
