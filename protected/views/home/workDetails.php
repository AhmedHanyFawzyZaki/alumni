                ...
                <div class="container-fluid">
                    <div class="col-md-5">
                        <div class="col-md-12 article-image">
                            <img class="width100per" src="<?= Yii::app()->request->getBaseUrl() ?>/files/uploads/works/<?= $model->image ?>"> 
                        </div>
                    ...
                    <div class="col-md-7">
                        <h2 class="article-title"><?= Helper::getTranslatedName($model, 'volunteer_work_name') ?></h2>
                        <div class="row">
                            <div class="col-sm-6">
...
<script>
    function participate(status) {
        ...
        if (login) {
            ...
            $.ajax({
                url: "<?= Yii::app()->request->getBaseUrl() ?>/home/workParticipate",
                data: {work:"<?= $model->volunteer_work_url ?>", status: status},
                type: 'POST',
