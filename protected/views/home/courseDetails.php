                ...
                <div class="container-fluid">
                    <div class="col-md-5">
                        <div class="col-md-12 article-image">
                            <img class="width100per" src="<?= Yii::app()->request->getBaseUrl() ?>/files/uploads/courses/<?= $model->image ?>"> 
                        </div>
                    ...
                    <div class="col-md-7">
                        <h2 class="article-title"><?= Helper::getTranslatedName($model, 'training_course_name') ?></h2>
                        <div class="row">
                            <div class="col-sm-6">
...
<script>
    function participate(status) {
        ...
        if (login) {
            ...
            $.ajax({
                url: "<?= Yii::app()->request->getBaseUrl() ?>/home/courseParticipate",
                data: {course: "<?= $model->training_course_url ?>", status: status},
                type: 'POST',
